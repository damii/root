...
jQuery(document).ready(function($) {
        $.fn.azu_exists = function () {
            return this.length !== 0;
        };

	var fnt_icons = azuIconPicker.icons;

//	// azu fontIconPicker
//	$('.azuIconPicker').fontIconPicker({
//		source: fnt_icons,
//		theme: 'fip-darkgrey',
//		iconsPerPage: 20
//	});
    
        // bind to click event for each item on the page
        $('.azuIconPicker').live('focus',function(event) {
            
            if(!$(this).parent().find('div').azu_exists())
                $(this).fontIconPicker({
                    source: fnt_icons,
                    theme: 'fip-darkgrey',
                    iconsPerPage: 20
