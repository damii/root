...
/* Load the widget */
add_action( 'widgets_init', array( 'Azzu_Widgets_RecentPosts', 'azzu_register_widget' ) );

class Azzu_Widgets_RecentPosts extends WP_Widget {
	...
	function __construct() {  
            /* Widget settings. */
                    $widget_ops = array( 'description' => _x( 'Recent posts', 'widget', 'azzu'.LANG_DN ) );

            /* Create the widget. */
            parent::__construct(
                'azzu-recent-posts',
                AZU_WIDGET_PREFIX . _x( 'Recent posts', 'widget', 'azzu'.LANG_DN ),
                $widget_ops
            );
	}
