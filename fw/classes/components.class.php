...
/* checkbox */
class AZU_Mcheckbox extends AZU_Item {   
...
/* radiobox */
class AZU_Mradio extends AZU_Item {    
...
/* select */
class AZU_Mselect extends AZU_Item {    
...
/* button */
class AZU_Mbutton extends AZU_Item {
...
/* text */
class AZU_Mtext extends AZU_Item {
...
/* textarea */
class AZU_Mtextarea extends AZU_Item {
...
/* link */
class AZU_Mlink extends AZU_Item {
    public $wrap = '%1$s';
    public $desc_wrap = '%2$s';
    public $href = '#';
    public $desc = '';
